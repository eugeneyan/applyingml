...
const ResourcesPage = ({
  ...
  return (
    <Layout>
      ...
      <p>
        Guides and teardowns on how to apply machine learning in production. Want to contribute a
        piece or suggest edits? Please <a href="mailto:applyingml@gmail.com">reach out</a> or make a{' '}
        <a
