...
const MentorsPage = ({
  ...
  return (
    <Layout>
      ...
      <p>
        Stories & advice from machine learning practitioners. Want to contribute an interview or
        recommend someone? Please <a href="mailto:applyingml@gmail.com">reach out</a> or make a{' '}
        <a
