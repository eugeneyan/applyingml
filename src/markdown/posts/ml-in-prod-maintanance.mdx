...
In the [previous post](/posts/challenges-of-machine-learning-in-production/), we discussed six little-known challenges _after_ deploying machine learning. This follow-up will share some practices I’ve found useful to maintaining machine learning in production.
