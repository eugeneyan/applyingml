...
By reading papers, we were able to learn what others have found to work (and not work). We can then adapt their approach and not have to reinvent the rocket. This helps us **deliver a working solution with lesser time and effort**.
...
Lastly, if I think it’ll be useful for others, I write about what I’ve learnt and publish it online. Relative to starting from scratch, having my notes as a reference makes writing much easier.
