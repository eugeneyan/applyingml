---
title: "Machine Learning Design Docs"
...
We’ll go over pointers on what to cover in **design docs for machine learning systems**—these pointers will guide the thinking process. My design docs tend to be structured via the [Why, What, How]({{ site.baseurl }}{% link posts/_posts/2021-02-28-writing-why-what-how.md %}#writing-framework-why-what-how-who) framework shared last week (please skim it if you've not read it yet). Then, I’ll share how I get feedback via a two-step review process.
...
Whether you’re writing your first or 20th design doc for a machine learning system, I hope this write-up will be helpful for you. Did I miss anything? Reach out [@eugeneyan](https://twitter.com/eugeneyan)!