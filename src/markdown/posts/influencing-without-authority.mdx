...
An effective way to convince and help people decide is the [Socratic method](https://en.wikipedia.org/wiki/Socratic_method){:target="_blank"}. Instead of telling people how to think, or what to do, ask questions that will make them think about it. Once they think about it, they’ll care about it. And once they care about it, they’ll act on it.
...
I’ve found socializing ideas with stakeholders one-on-one useful. This allows me to share my perspective, understand their views and concerns, and work out hairy issues without concern of anyone [losing face](https://www.merriam-webster.com/dictionary/lose%20face){:target="_blank"}. It may require a bit more time and effort, but the outcome more than makes up for it.
...
Are they [“Why”, “What”, or “How”]({{ site.baseurl }}{% link posts/_posts/2021-02-28-writing-why-what-how.md %}){:target="_blank"} people? Most people focus on one or two, though this changes across scenarios (e.g., roadmap planning, design review, correction of error). Knowing and targeting the Why, What, or How helps you meet them where they are and address their concerns. 
