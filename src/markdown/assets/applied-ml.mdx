---
title: "Papers on Applied Machine Learning"
description: "Curated papers, articles, and blogs on data science & machine learning in production. ⚙️"
date: "2020-05-04"
slug: "/applied-ml/"
---
Curated papers, articles, and blogs on **data science & ML in production**. ⚙️ Designing your ML system? Learn how other organizations did it:

- **How** the problem is framed 🔎 (e.g., personalization as recsys vs. search)
- **What** approach and techniques worked ✅ (and what didn't ❌)
- **Why** it works, with research, literature, and references 📂
- **What** real-world results were achieved (to better assess ROI ⏰💰📈)
