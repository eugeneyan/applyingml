...
We built [Duo Trust Monitor](https://duo.com/docs/trust-monitor), which provides security administrators with a daily feed of login attempts that our algorithms have flagged as anomalous. You can check out more information about how our anomaly detection models work in a recent talk some of my coworkers gave at DefCon’s [AI Village](https://aivillage.org/events/2020/8/4/ai-village-def-con-28-safe-mode-w6wsl) - the recording should be posted any day now and I’ll update with a link when it’s available.
