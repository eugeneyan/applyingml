...
We interact with backend engineers to fix up the contract and configuration but MLE does the full ML deployment. You can learn to deploy ML on serverless over [here](https://github.com/bhavsarpratik/serverless-transformers-on-aws-lambda).
...
I am quite surprised by the power of AWS Lambda! Couple it with event-driven architecture using AWS EventBridge and bamm.
